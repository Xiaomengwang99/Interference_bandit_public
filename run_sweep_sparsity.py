"""
Sparsity sweep: evaluate algorithms under varying sparsity levels.
...
NOTE ON REUSED BASELINE RESULTS:
    ...
    simulations (see output_simulations_new_sparsity_partial01/). Only NETC,
...
OUTPUT_DIR = Path(__file__).resolve().parent / "output_sweep_sparsity"
